...
public class MainActivity extends Activity implements OnItemSelectedListener {
	...
	private String URL_NEW_CATEGORY = "http://192.168.17.2/food_api/new_category.php";
	// Url to get all categories
	private String URL_CATEGORIES = "http://192.168.17.2/food_api/get_categories.php";
